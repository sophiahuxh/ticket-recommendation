...
public class MongoDBConnection implements DBConnection{
	...
	public Set<String> getFavoriteItemIds(String userId) {
		...
		if (iterable.first() != null && ((Document) iterable.first()).containsKey("favorite")) {
			Document doc = (Document) iterable.first();
			@SuppressWarnings("unchecked")
			List<String> itemIds = (List<String>) doc.get("favorite");
			favItemIds.addAll(itemIds);
		}
	...
	public Set<String> getCategories(String itemId) {
		...
		if (iterable.first() != null) {
			Document doc = (Document) iterable.first();
			List<String> lists = (List<String>)doc.get("categories");
			if (lists != null) {
			   categories.addAll(lists);
			}
		}
	...
	public void saveItem(Item item) {
		...
		FindIterable<Document> iterable = collection.find(eq("item_id",item.getItemId()));
	...
	public String getFullname(String userId) {
		// TODO Auto-generated method stub
		String fullname = "";
		FindIterable iterable = db.getCollection("users").find(eq("user_id", userId));
		
		if (iterable.first() != null) {
			Document doc = (Document) iterable.first();
			fullname = doc.get("first_name") + " " + doc.get("last_name");
		}
