...
public class RpcHelperTest {
	...
	public void testGetJSONArray() throws JSONException {
		...
		ItemBuilder itemBuilderOne = new ItemBuilder();
		itemBuilderOne.setItemId("one");
		itemBuilderOne.setRating(5);
		itemBuilderOne.setCategories(category); 
		Item one = itemBuilderOne.build();
		

		ItemBuilder itemBuilderTwo = new ItemBuilder();
		itemBuilderTwo.setItemId("two");
		itemBuilderTwo.setRating(5);
		itemBuilderTwo.setCategories(category); 
		Item two = itemBuilderOne.build();
